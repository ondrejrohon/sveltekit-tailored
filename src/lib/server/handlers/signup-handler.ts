...
import { checkEmailAvailability, verifyEmailInput } from '$lib/server/lucia-auth/email.js';
import { createUser } from '$lib/server/lucia-auth/user.js';
...
export const signupLoadHandler = async (event: RequestEvent) => {
