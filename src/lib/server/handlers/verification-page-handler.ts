...
} from '$lib/server/lucia-auth/email-verification.js';
import { invalidateUserPasswordResetSessions } from '$lib/server/lucia-auth/password-reset.js';
import { updateUserEmailAndSetEmailAsVerified } from '$lib/server/lucia-auth/user.js';
import { ExpiringTokenBucket } from '$lib/server/lucia-auth/rate-limit.js';

import type { Actions, RequestEvent } from '@sveltejs/kit';
import { sendVerificationEmail } from '$lib/server/lucia-auth/email-verification.js';

export async function verificationLoadHandler(event: RequestEvent) {
...
export const verificationActions: Actions = {
	verify: verifyCode,
	resend: resendEmail
};
