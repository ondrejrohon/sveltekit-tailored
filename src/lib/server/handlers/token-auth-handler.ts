...
import { generateTokens, verifyRefreshToken } from '$lib/server/jwt-auth.js';
...
export async function jwtLoginHandler({ request }: RequestEvent) {
...
export async function jwtRefreshHandler({ request }: RequestEvent) {
